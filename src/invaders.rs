...
const INVADERS_LINES: usize = 5;

const DURATION_STEP: u128 = 250;
const MINIMUM_DURATION: u128 = 250;
...
impl Invaders {
    ...
    pub fn update(&mut self, delta: Duration) -> bool {
        ...
        if self.move_timer.ready {
            ...
            if downwards {
                let new_duration = max(self.move_timer.duration.as_millis() - DURATION_STEP, MINIMUM_DURATION);
